...
std::bitset<64> const bitsetB10("0000000000000000000110000001100000111100011111100000000000000000") ;
...
unsigned long long int const b10 (138796567363584) ;
...
/*double endWeightForWhite(unsigned long long int r,unsigned long long int n,unsigned long long int b,
        unsigned long long int q,unsigned long long int k,unsigned long long int p)
        {
                return countSetBits2(q)
        }

int centerDist(unsigned long long int k){
