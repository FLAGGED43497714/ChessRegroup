...
extern int const LateNb = 20 ;

void Game(int depth1EARLY, int depth2EARLY, int depth1LATE, int depth2LATE){
    std::string nothing ;
    //std::cin >> nothing ;
    ...
    //std::string fen = "rn1qk2r/ppp2p2/5p1p/3b2p1/1b1P4/2N2Q1N/PPP2PPP/R3KB1R" ; //blunder dame en 1
    //std::string fen = "rn1qk2r/ppp2p2/5p1p/3b2p1/1b1P4/2N2Q1N/PPP2PPP/R2K1B1R" ;
        ...
        if (!(moveNb%2)){
            ...
            if (whiteHuman){
                ...
                for (int semIdx = 0 ; semIdx < moves.size()/2 ; semIdx++){
                    ...
                    thisEval = minimax(r,n,b,q,k,p,R,N,B,Q,K,P,CstlL,CstlS,cstlL,cstlS,enPassant,forbCstlS,forbCstlL,forbcstlS,forbcstlL,tempForbCstlS,tempForbCstlL,tempForbcstlS,tempForbcstlL, tempVariante, depthInit,depth1,depth2,-GAMEintINFINITY,GAMEintINFINITY,false,positionHash,moveNb) ;
            ...
            if (!legal){
                ...
                for (int semIdx = 0 ; semIdx < moves.size()/2 ; semIdx++){
                    ...
                    thisEval = minimax(r,n,b,q,k,p,R,N,B,Q,K,P,CstlL,CstlS,cstlL,cstlS,enPassant,forbCstlS,forbCstlL,forbcstlS,forbcstlL,tempForbCstlS,tempForbCstlL,tempForbcstlS,tempForbcstlL,tempVariante, depthInit,depth1,depth2,-GAMEintINFINITY,GAMEintINFINITY,true,positionHash,moveNb) ;
                    ump[positionHash] = {thisEval,depth2} ;
